...
Out-of-the-box ideas for UpSpeech social and beyond. Bold but brand-safe: each
one is checked against the sensitivity rules in
[`brand-voice.md`](brand-voice.md). Anything here can be turned into a batch;
nothing here ships without consent where real people are involved.

Each concept lists the **angle**, the **audience**, and the **why**.

## Recurring characters and series

- **Name the companion.** The product already has an animated companion
...
- **"Words we're tired of" series.** Gently reclaim the phrases people who
...
- Never a cure, an outcome promise, or "fluency" as the goal.
- Never mock or imitate stuttering, even affectionately.
- Real people only with written consent; no real client data ever.
- Parents get reassurance, never fear.
- Accessible by default: alt text, captions, high contrast.
