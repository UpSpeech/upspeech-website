...
export const es: Dictionary = {
  ...
  forSlps: {
    ...
    seoDescription:
      "UpSpeech da a los pacientes práctica estructurada entre sesiones y redacta las notas de sesiones de terapia de la tartamudez para que las revises, con progreso que puedes ver.",
    intro: {
      eyebrow: "Para logopedas",
