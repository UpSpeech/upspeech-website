    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 animate-fade-in-up">
          <p className="font-body text-sm text-secondary/80 uppercase tracking-wider mb-2">
            Trusted Partners
          </p>
          ...
          >
            {marqueePartners.map((partner, index) => (
              ...
              >
                ...
                {partner.description && (
                  <span className="font-body text-xs text-secondary/80 group-hover:text-secondary/90 transition-colors duration-300">
                    {partner.description}
                  </span>
                )}
              </a>
